defmodule AlphaVantage do
  ...
  The `AlphaVantage.Cryptocurrenies`,`AlphaVantage.Forex`, `AlphaVantage.StockTimeSeries`, and `AlphaVantage.TechnicalIndicators` modules can be leveraged for more structured and explicit inputs, per function.
